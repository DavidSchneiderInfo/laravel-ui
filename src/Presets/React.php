...
class React extends Preset
{
    ...
    {
        copy(PackageServiceProvider::PACKAGE_PATH.'/../stubs/react/vite.config.js', base_path('vite.config.js'));
    }
    ...
    protected static function updateComponent()
    {
        ...
        copy(
            PackageServiceProvider::PACKAGE_PATH.'/../stubs/react/Example.jsx',
    ...
    {
        copy(PackageServiceProvider::PACKAGE_PATH.'/../stubs/react/app.js', resource_path('js/app.js'));
    }
